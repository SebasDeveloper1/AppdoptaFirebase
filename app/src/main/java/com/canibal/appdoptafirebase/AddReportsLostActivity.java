...
public class AddReportsLostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_reports_lost);

        actionBar = getSupportActionBar();
        actionBar.setTitle(R.string.txttiletoolbar_addnewreportlost);
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sex.equals(txtGenero)) {
                    ...
                    Toast.makeText(AddReportsLostActivity.this, txterrorsexadoption, Toast.LENGTH_SHORT).show();
                    return;
                }
                if (state.equals(txtEstadoReproductivo)) {
                    String txterrorstateadoption = getString(R.string.txterrorstateadoption);
                    Toast.makeText(AddReportsLostActivity.this, txterrorstateadoption, Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        ref.child(editPostId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        closeimageBtn.setVisibility(View.GONE);
                        Toast.makeText(AddReportsLostActivity.this, R.string.Updatingtxt, Toast.LENGTH_SHORT).show();
                        onBackPressed();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        pd.dismiss();
                        Toast.makeText(AddReportsLostActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void updateWithNowImage(final String title, final String age, final String species, final String race, final String sex, final String state, final String location, final String description, final String editPostId) {
        ...
        final String timeStamp = String.valueOf(System.currentTimeMillis());
        String filePathAndName = "ReportsLost/" + "reportslost_" + timeStamp;
    ...
    private void loadPostData(final String editPostId) {
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("ReportsLost");
                                ...
                                ref.child(timeStamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                ...
                                                pd.dismiss();
                                                Toast.makeText(AddReportsLostActivity.this, R.string.txtpostpublished, Toast.LENGTH_SHORT).show();
                                                //reset views
                                                //restablecer vistas
                                                titleEt.setText("");
                                                pAgeEt.setText("");
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest("https://fcm.googleapis.com/fcm/send", notificationJo,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        //error occured
                        Toast.makeText(AddReportsLostActivity.this, "" + error.toString(), Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
    ...
    public boolean onSupportNavigateUp() {
        ...
        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(AddReportsLostActivity.this);
