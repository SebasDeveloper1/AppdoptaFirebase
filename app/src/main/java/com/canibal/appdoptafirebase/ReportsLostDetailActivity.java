...
public class ReportsLostDetailActivity extends AppCompatActivity {
    ...
    TextView uNameTv, pTimeTiv, pTitleTv, pSpeciesTv, pRaceTv, pLocationTv, pSexTv, pAgeTv, pStateTv, pDescriptionTv, pCommentsTv;
    Button pContactBtn;
    FloatingActionsMenu fabgroup;
    FloatingActionButton commentBtn, shareBtn, moreBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reports_lost_detail);
        ...
        uNameTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (hisUid.equals(myUid)) {
                    ...
                    Intent intent = new Intent(ReportsLostDetailActivity.this, Dashboard2Activity.class);
                    intent.putExtra("uid", hisUid);
                    startActivity(intent);

                } else {
                    Intent intent = new Intent(ReportsLostDetailActivity.this, ThereProfileActivity.class);
                    intent.putExtra("uid", hisUid);
                    startActivity(intent);
                }
            }
        ...
        pImageIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ReportsLostDetailActivity.this, DetailImageActivity.class);
        ...
        commentBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ReportsLostDetailActivity.this, PostCommentByActivity.class);
                intent.putExtra("postId", postId);
                intent.putExtra("postType", "ReportsLost");
                startActivity(intent);
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot ds : dataSnapshot.getChildren()) {
                            ...
                            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {// Si el API es < a 23
                                ...
                                if (ContextCompat.checkSelfPermission(ReportsLostDetailActivity.this, Manifest.permission.CALL_PHONE) == PackageManager.PERMISSION_GRANTED) {
                                    call(phone);
                                } else {
                                    if (ActivityCompat.shouldShowRequestPermissionRationale(ReportsLostDetailActivity.this, Manifest.permission.CALL_PHONE)) {//true
                                    } else {
                                    }
                                    ActivityCompat.requestPermissions(ReportsLostDetailActivity.this, new String[]{Manifest.permission.CALL_PHONE}, REQUEST_PERMISSION_CALL);
                                }
                            }
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot ds : dataSnapshot.getChildren()) {
                            if (ds.exists()) {
                                ...
                                Toast.makeText(ReportsLostDetailActivity.this, blocketuserpositive, Toast.LENGTH_SHORT).show();
                                //blocked dont proceed further
                                return;
                            }
                        }
                        //not blocked start activity chat
                        Intent intent = new Intent(ReportsLostDetailActivity.this, ChatActivity.class);
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                ...
                if (id == 0) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(ReportsLostDetailActivity.this);
                    builder.setTitle("");
                    ...
                    builder.setPositiveButton(R.string.txtdelete, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            //delete is clicked
                            beginDelete();
                            Toast.makeText(ReportsLostDetailActivity.this, R.string.txtdeletepost, Toast.LENGTH_SHORT).show();
                        }
                    });
                    ...
                    builder.setPositiveButton(R.string.txtedit, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Intent intent = new Intent(ReportsLostDetailActivity.this, AddReportsLostActivity.class);
        ...
        picRef.delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Query fquery = FirebaseDatabase.getInstance().getReference("ReportsLost").orderByChild("pId").equalTo(postId);
                        fquery.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                //deleted
                                Toast.makeText(ReportsLostDetailActivity.this, R.string.deletedpost, Toast.LENGTH_SHORT).show();
                                pd.dismiss();
                            }
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        pd.dismiss();
                        Toast.makeText(ReportsLostDetailActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
