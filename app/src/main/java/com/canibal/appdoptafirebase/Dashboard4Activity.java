...
public class Dashboard4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle(R.string.txttiletoolbar_Notifications); // change actionbar title -- cambia el título de la barra de acción
    ...
    private void checkUserStatus() {
        ...
        if (user != null) {
            ...
            startActivity(new Intent(Dashboard4Activity.this, LoginActivity.class));
            finish();
        }
    }
