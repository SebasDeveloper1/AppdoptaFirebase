...
public class Dashboard3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //chats fratment transaction (default) -- transacción en chats (por defecto al iniciar)
        //chats fratment transaction -- transacción en chats
        actionBar.setTitle(R.string.txttiletoolbar_chatslist); // change actionbar title -- cambia el título de la barra de acción
    ...
    private void checkUserStatus() {
        ...
        if (user != null) {
            ...
            startActivity(new Intent(Dashboard3Activity.this, LoginActivity.class));
            finish();
        }
    }
