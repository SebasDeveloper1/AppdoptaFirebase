...
public class AddReportsFoundActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_reports_found);

        actionBar = getSupportActionBar();
        actionBar.setTitle(R.string.txttiletoolbar_addnewreportfound);
        ...
        ArrayAdapter<CharSequence> adapterstate = ArrayAdapter.createFromResource(this,
                R.array.spinner_items_state_found, android.R.layout.simple_spinner_item);
        ...
        if (isUpdateKey.equals("editPost")) {
            //update-actualice
            actionBar.setTitle(R.string.txttiletoolbar_updatereportlost);
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(title)) {
                    title = getString(R.string.txthintnameofpetNN);
                }
                if (TextUtils.isEmpty(age)) {
                    age = getString(R.string.txtSindefinirfound);
                }
                if (TextUtils.isEmpty(species)) {
                    species = getString(R.string.txtSindefinirfound);
                }
                if (TextUtils.isEmpty(race)) {
                    race = getString(R.string.txtSindefinirfound);
                }
                if (sex.equals(txtGenero)) {
                    String txterrorsexadoption = getString(R.string.txterrorsexadoption);
                    Toast.makeText(AddReportsFoundActivity.this, txterrorsexadoption, Toast.LENGTH_SHORT).show();
                    return;
                }
                if (state.equals(txtEstadoReproductivo)) {
                    String txterrorstateadoption = getString(R.string.txterrorstateadoption);
                    Toast.makeText(AddReportsFoundActivity.this, txterrorstateadoption, Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        ref.child(editPostId)
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        closeimageBtn.setVisibility(View.GONE);
                        Toast.makeText(AddReportsFoundActivity.this, R.string.Updatingtxt, Toast.LENGTH_SHORT).show();
                        onBackPressed();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        pd.dismiss();
                        Toast.makeText(AddReportsFoundActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void updateWithNowImage(final String title, final String age, final String species, final String race, final String sex, final String state, final String location, final String description, final String editPostId) {
        ...
        final String timeStamp = String.valueOf(System.currentTimeMillis());
        String filePathAndName = "ReportsFound/" + "reportsfound_" + timeStamp;
    ...
    private void loadPostData(final String editPostId) {
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("ReportsFound");
        ...
        fquery.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    String txtSindefinirfound = getString(R.string.txtSindefinirfound);
                    ...
                    } else if (editState.equals(txtSindefinirfound)) {
                        pStateEt.setSelection(3);
                    }
                                ...
                                ref.child(timeStamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                ...
                                                pd.dismiss();
                                                Toast.makeText(AddReportsFoundActivity.this, R.string.txtpostpublished, Toast.LENGTH_SHORT).show();
                                                //reset views
                                                //restablecer vistas
                                                titleEt.setText("");
                                                pAgeEt.setText("");
                                                ...
                                                String msmnotificationlost = getString(R.string.msmnotificationlost);
                                                prepareNotification(
                                                        "" + timeStamp, //since we are using timeStamp for post id
                                                        "" + name,//message of the notification
                                                        "" + title + "\n" + msmnotificationlost,
                                                        "ReportsFoundNotification",
                                                        "POST"
                                                );
                                                onBackPressed();
                                            }
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest("https://fcm.googleapis.com/fcm/send", notificationJo,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        //error occured
                        Toast.makeText(AddReportsFoundActivity.this, "" + error.toString(), Toast.LENGTH_SHORT).show();
                    }
                }) {
            @Override
    ...
    private void showMessageDialog() {
        ...
        View view = LayoutInflater.from(AddReportsFoundActivity.this).inflate(R.layout.dialog_message_report_found, null);
        final TextView txtnameuser = view.findViewById(R.id.txtnameuser);
        final FloatingActionButton closeBtn = view.findViewById(R.id.closeBtn);
        ...
        final android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(AddReportsFoundActivity.this);
    ...
    public boolean onSupportNavigateUp() {
        ...
        android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(AddReportsFoundActivity.this);
