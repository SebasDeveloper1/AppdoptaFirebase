...
public class AdoptionDetailActivity extends AppCompatActivity {
    ...
    TextView uNameTv, pTimeTiv, pTitleTv, pSpeciesTv, pRaceTv, pLocationTv, pSexTv, pAgeTv, pStateTv, pDescriptionTv, pLikesTv, pCommentsTv;
    ImageButton moreBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pSpeciesTv = findViewById(R.id.pSpeciesTv);
        pRaceTv = findViewById(R.id.pRaceTv);
        pLocationTv = findViewById(R.id.pLocationTv);
        pSexTv = findViewById(R.id.pSexTv);
        pAgeTv = findViewById(R.id.pAgeTv);
        pStateTv = findViewById(R.id.pStateTv);
        ...
        uNameTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (hisUid.equals(myUid)) {
                    ...
                    Intent intent = new Intent(AdoptionDetailActivity.this, Dashboard2Activity.class);
                    intent.putExtra("uid", hisUid);
                    startActivity(intent);

                } else {
                    Intent intent = new Intent(AdoptionDetailActivity.this, ThereProfileActivity.class);
                    intent.putExtra("uid", hisUid);
                    startActivity(intent);
                }
            }
        ...
        pImageIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(AdoptionDetailActivity.this, DetailImageActivity.class);
        ...
        commentBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(AdoptionDetailActivity.this, PostCommentByActivity.class);
        ...
        shareBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String pSpecies = pSpeciesTv.getText().toString().trim();
                String pRace = pRaceTv.getText().toString().trim();
                String pLocation = pLocationTv.getText().toString().trim();
                String pSex = pSexTv.getText().toString().trim();
                String pAge = pAgeTv.getText().toString().trim();
                String pState = pStateTv.getText().toString().trim();
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot ds : dataSnapshot.getChildren()) {
                            ...
                            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {// Si el API es < a 23
                                ...
                                if (ContextCompat.checkSelfPermission(AdoptionDetailActivity.this, Manifest.permission.CALL_PHONE) == PackageManager.PERMISSION_GRANTED) {
                                    call(phone);
                                } else {
                                    if (ActivityCompat.shouldShowRequestPermissionRationale(AdoptionDetailActivity.this, Manifest.permission.CALL_PHONE)) {//true
                                    } else {
                                    }
                                    ActivityCompat.requestPermissions(AdoptionDetailActivity.this, new String[]{Manifest.permission.CALL_PHONE}, REQUEST_PERMISSION_CALL);
                                }
                            }
        ...
        pLikesTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AdoptionDetailActivity.this, PostLikedByActivity.class);
                intent.putExtra("postId", postId);
                intent.putExtra("postType", "Adoptions");
                startActivity(intent);
            }
    ...
    private void shareTextOnly(String pTitle, String pSpecies, String pRace, String pLocation, String pSex, String pAge, String pState, String pDescription) {
        ...
        String txthintnameofpet = getString(R.string.txthintnameofpet);
        String txthintspeciesofpet = getString(R.string.txthintspeciesofpet);
        String txthintraceofpet = getString(R.string.txthintraceofpet);
        String txthintlocationofpet = getString(R.string.txthintlocationofpet);
        String txthintsexofpet = getString(R.string.txthintsexofpet);
        String txthintageofpet = getString(R.string.txthintageofpet);
        String txthintstateofpet = getString(R.string.txthintstateofpet);
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot ds : dataSnapshot.getChildren()) {
                            if (ds.exists()) {
                                ...
                                Toast.makeText(AdoptionDetailActivity.this, blocketuserpositive, Toast.LENGTH_SHORT).show();
                                //blocked dont proceed further
                                return;
                            }
                        }
                        //not blocked start activity chat
                        Intent intent = new Intent(AdoptionDetailActivity.this, ChatActivity.class);
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                ...
                if (id == 0) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(AdoptionDetailActivity.this);
                    builder.setTitle("");
                    ...
                    builder.setPositiveButton(R.string.txtdelete, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            //delete is clicked
                            beginDelete();
                            Toast.makeText(AdoptionDetailActivity.this, R.string.txtdeletepost, Toast.LENGTH_SHORT).show();
                        }
                    });
                    ...
                    builder.setPositiveButton(R.string.txtedit, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Intent intent = new Intent(AdoptionDetailActivity.this, AddAdoptionActivity.class);
        ...
        picRef.delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Query fquery = FirebaseDatabase.getInstance().getReference("Adoptions").orderByChild("pId").equalTo(postId);
                        fquery.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                //deleted
                                Toast.makeText(AdoptionDetailActivity.this, R.string.deletedpost, Toast.LENGTH_SHORT).show();
                                pd.dismiss();
                            }
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        pd.dismiss();
                        Toast.makeText(AdoptionDetailActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        likesRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child(postId).hasChild(myUid)) {
                    ...
                    likeBtn.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_heart_primary, 0, 0, 0);
                     ...
                     * Cambiar el icono izquierdo dibujable del botón
                     * cambia el texto del botón Me gusta de "Me gusta" a "Me gusta" */
                    likeBtn.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_heart_black, 0, 0, 0);
                    String likebtn = getString(R.string.likebtn);
                    likeBtn.setText(likebtn);
                }
            }
    ...
    private void likePost() {
        ...
        final DatabaseReference likesRef = FirebaseDatabase.getInstance().getReference().child("Likes");
        final DatabaseReference postsRef = FirebaseDatabase.getInstance().getReference().child("Adoptions");
        likesRef.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (mProcessLike) {
                    if (dataSnapshot.child(postId).hasChild(myUid)) {
                        ...
                        if (!hisUid.equals(myUid)) {
                            ...
                            addToHisNotifications("" + hisUid, "" + postId, txtnotifiliked, "Adoptions");
                        }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    String pAge = "" + ds.child("pAge").getValue();
                    String pSpecies = "" + ds.child("pSpecies").getValue();
                    String pRace = "" + ds.child("pRace").getValue();
                    String pSex = "" + ds.child("pSex").getValue();
                    ...
                    pSpeciesTv.setText(pSpecies);
                    pRaceTv.setText(pRace);
