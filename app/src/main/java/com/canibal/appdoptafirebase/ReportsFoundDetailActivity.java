...
public class ReportsFoundDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reports_found_detail);
        ...
        uNameTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (hisUid.equals(myUid)) {
                    ...
                    Intent intent = new Intent(ReportsFoundDetailActivity.this, Dashboard2Activity.class);
                    intent.putExtra("uid", hisUid);
                    startActivity(intent);

                } else {
                    Intent intent = new Intent(ReportsFoundDetailActivity.this, ThereProfileActivity.class);
                    intent.putExtra("uid", hisUid);
                    startActivity(intent);
                }
            }
        ...
        pImageIv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ReportsFoundDetailActivity.this, DetailImageActivity.class);
        ...
        commentBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ReportsFoundDetailActivity.this, PostCommentByActivity.class);
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot ds : dataSnapshot.getChildren()) {
                            ...
                            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {// Si el API es < a 23
                                ...
                                if (ContextCompat.checkSelfPermission(ReportsFoundDetailActivity.this, Manifest.permission.CALL_PHONE) == PackageManager.PERMISSION_GRANTED) {
                                    call(phone);
                                } else {
                                    if (ActivityCompat.shouldShowRequestPermissionRationale(ReportsFoundDetailActivity.this, Manifest.permission.CALL_PHONE)) {//true
                                    } else {
                                    }
                                    ActivityCompat.requestPermissions(ReportsFoundDetailActivity.this, new String[]{Manifest.permission.CALL_PHONE}, REQUEST_PERMISSION_CALL);
                                }
                            }
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        for (DataSnapshot ds : dataSnapshot.getChildren()) {
                            if (ds.exists()) {
                                ...
                                Toast.makeText(ReportsFoundDetailActivity.this, blocketuserpositive, Toast.LENGTH_SHORT).show();
                                //blocked dont proceed further
                                return;
                            }
                        }
                        //not blocked start activity chat
                        Intent intent = new Intent(ReportsFoundDetailActivity.this, ChatActivity.class);
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                ...
                if (id == 0) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(ReportsFoundDetailActivity.this);
                    builder.setTitle("");
                    ...
                    builder.setPositiveButton(R.string.txtdelete, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            //delete is clicked
                            beginDelete();
                            Toast.makeText(ReportsFoundDetailActivity.this, R.string.txtdeletepost, Toast.LENGTH_SHORT).show();
                        }
                    });
                    ...
                    builder.setPositiveButton(R.string.txtedit, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Intent intent = new Intent(ReportsFoundDetailActivity.this, AddReportsFoundActivity.class);
        ...
        picRef.delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Query fquery = FirebaseDatabase.getInstance().getReference("ReportsFound").orderByChild("pId").equalTo(postId);
                        fquery.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                //deleted
                                Toast.makeText(ReportsFoundDetailActivity.this, R.string.deletedpost, Toast.LENGTH_SHORT).show();
                                pd.dismiss();
                            }
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        pd.dismiss();
                        Toast.makeText(ReportsFoundDetailActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
