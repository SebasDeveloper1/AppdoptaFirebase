...
public class AdapterPosts extends RecyclerView.Adapter<AdapterPosts.MyHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyHolder myHolder, final int i) {
        ...
        //metodo que muestra la opcion "ver mas" que aumenta el tamaño del textview si el el
        // texto que contiene es mayor a 7 lineas
        myHolder.pDescriptionTv.post(new Runnable() {
            @Override
            public void run() {
                int lineCount = myHolder.pDescriptionTv.getLineCount();

                if (lineCount >= 7) {

                    myHolder.seeMoreTv.setVisibility(View.VISIBLE);

                    myHolder.seeMoreTv.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            myHolder.pDescriptionTv.setMaxLines(100);
                            myHolder.seeMoreTv.setVisibility(View.GONE);
                            myHolder.seeLessTv.setVisibility(View.VISIBLE);

                            myHolder.seeLessTv.setOnClickListener(new View.OnClickListener() {
                                @Override
                                public void onClick(View v) {
                                    myHolder.pDescriptionTv.setMaxLines(7);
                                    myHolder.seeLessTv.setVisibility(View.GONE);
                                    myHolder.seeMoreTv.setVisibility(View.VISIBLE);
                                }
                            });
                        }
                        ...
                        if (mProcessLike) {
                            if (dataSnapshot.child(postIde).hasChild(myUid)) {
                                ...
                                if (!uid.equals(myUid)) {
                                    ...
                                    addToHisNotifications("" + uid, "" + pId, txtnotifiliked, "Posts");
                                }
                            }
                        }
                    }
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        TextView uNameTv, pTimeTv, pTitleTv, pDescriptionTv, pLikesTv, pCommentsTv, seeMoreTv, seeLessTv;
        ImageButton moreBtn;
        ...
        public MyHolder(@NonNull View itemView) {
            ...
            seeLessTv = itemView.findViewById(R.id.seeLessTv);
