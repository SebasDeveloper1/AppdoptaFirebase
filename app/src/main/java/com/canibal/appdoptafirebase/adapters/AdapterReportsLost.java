...
public class AdapterReportsLost extends RecyclerView.Adapter<AdapterReportsLost.MyHolder> {
    ...
    private DatabaseReference reportsLostRef; // reference of posts

    boolean mProcessLike = false;

    public AdapterReportsLost(Context context, List<ModelReportsLost> reportsLostList) {
        this.context = context;
        this.reportsLostList = reportsLostList;
        myUid = FirebaseAuth.getInstance().getCurrentUser().getUid();
        reportsLostRef = FirebaseDatabase.getInstance().getReference().child("ReportsLost");
    }
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.row_reports_lost, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final MyHolder myHolder, final int i) {
        //get data
        //obtener datos
        final String uid = reportsLostList.get(i).getUid();
        String uEmail = reportsLostList.get(i).getuEmail();
        String uName = reportsLostList.get(i).getuName();
        String uDp = reportsLostList.get(i).getuDp();
        final String pId = reportsLostList.get(i).getpId();
        final String pTitle = reportsLostList.get(i).getpTitle();
        final String pAge = reportsLostList.get(i).getpAge();
        final String pSpecies = reportsLostList.get(i).getpSpecies();
        final String pRace = reportsLostList.get(i).getpRace();
        final String pSex = reportsLostList.get(i).getpSex();
        final String pState = reportsLostList.get(i).getpState();
        final String pLocation = reportsLostList.get(i).getpLocation();
        final String pDescription = reportsLostList.get(i).getpDescr();
        final String pImage = reportsLostList.get(i).getpImage();
        String pTimeStamp = reportsLostList.get(i).getpTime();
        String pLikes = reportsLostList.get(i).getpLikes(); //contenedor para el numero total de likes del post
        String pComments = reportsLostList.get(i).getpComments(); //contenedor para el numero total de likes del post
                ...
                if (id == 0) {
                    ...
                    builder.setPositiveButton(R.string.txtedit, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Intent intent = new Intent(context, AddReportsLostActivity.class);
        ...
        picRef.delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Query fquery = FirebaseDatabase.getInstance().getReference("ReportsLost").orderByChild("pId").equalTo(pId);
