...
import com.canibal.appdoptafirebase.AddServiceActivity;
...
public class AdapterServices extends RecyclerView.Adapter<AdapterServices.MyHolder> {
    ...
    public AdapterServices(Context context, List<ModelServices> servicesList) {
        this.context = context;
        this.servicesList = servicesList;
        myUid = FirebaseAuth.getInstance().getCurrentUser().getUid();
        likesRef = FirebaseDatabase.getInstance().getReference().child("Likes");
        postsRef = FirebaseDatabase.getInstance().getReference().child("Services");
    }

    @NonNull
    @Override
    public MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        //inflate layout row_services.xml
        View view = LayoutInflater.from(context).inflate(R.layout.row_services, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final MyHolder myHolder, final int i) {
        //get data
        //obtener datos
        final String uid = servicesList.get(i).getUid();
        String uEmail = servicesList.get(i).getuEmail();
        String uName = servicesList.get(i).getuName();
        String uDp = servicesList.get(i).getuDp();
        final String pId = servicesList.get(i).getpId();
        final String pTitle = servicesList.get(i).getpTitle();
        final String pCategory = servicesList.get(i).getpCategory();
        final String pLocation = servicesList.get(i).getpLocation();
        final String pSchedule = servicesList.get(i).getpSchedule();
        final String pServicewebsite = servicesList.get(i).getpServicewebsite();
        final String pNumercontact = servicesList.get(i).getpNumercontact();
        final String ccp = servicesList.get(i).getCcp();
        final String pDescription = servicesList.get(i).getpDescr();
        final String pImage = servicesList.get(i).getpImage();
        String pTimeStamp = servicesList.get(i).getpTime();
        String pLikes = servicesList.get(i).getpLikes(); //contenedor para el numero total de likes del post
        String pComments = servicesList.get(i).getpComments(); //contenedor para el numero total de likes del post
        ...
        myHolder.pLocationTv.setText(pLocation);
        myHolder.pScheduleTv.setText(pSchedule);
        ...
        myHolder.likeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final int pLikes = Integer.parseInt(servicesList.get(i).getpLikes());
                mProcessLike = true;
                //get id of the post clicked
                final String postIde = servicesList.get(i).getpId();
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if (mProcessLike) {
                            if (dataSnapshot.child(postIde).hasChild(myUid)) {
                                ...
                                if (!uid.equals(myUid)) {
                                    String txtnotifilikedservice = context.getString(R.string.txtnotifilikedservice);
                                    addToHisNotifications("" + uid, "" + pId, txtnotifilikedservice, "Services");
                                }
                            }
                        }
                    }
        ...
        myHolder.shareBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bitmapDrawable == null) {
                    //post without image
                    shareTextOnly(pTitle, pCategory, pLocation, pSchedule, pServicewebsite, ccp, pNumercontact, pDescription);
                } else {
                    //post with image

                    //convert image to bitmap
                    Bitmap bitmap = bitmapDrawable.getBitmap();
                    shareImageAndText(pTitle, pCategory, pLocation, pSchedule, pServicewebsite, ccp, pNumercontact, pDescription, bitmap);
                }
            }
        });
    ...
    private void shareTextOnly(String pTitle, String pCategory, String pLocation, String pSchedule, String pServicewebsite, String ccp, String pNumercontact, String pDescription) {
        String txtservicename = context.getString(R.string.txtservicename);
        String txtservicecategory = context.getString(R.string.txtservicecategory);
        String txthintlocationofpet = context.getString(R.string.txthintlocationofpet);
        String txtserviceschedule2 = context.getString(R.string.txtserviceschedule2);
        String txtservicenumercontact = context.getString(R.string.txtservicenumercontact);
        String txtservicewebsite2 = context.getString(R.string.txtservicewebsite2);
    ...
    private void shareImageAndText(String pTitle, String pCategory, String pLocation, String pSchedule, String pServicewebsite, String ccp, String pNumercontact, String pDescription, Bitmap bitmap) {
        //concatenate title and description to share
        String txtservicename = context.getString(R.string.txtservicename);
        String txtservicecategory = context.getString(R.string.txtservicecategory);
        String txthintlocationofpet = context.getString(R.string.txthintlocationofpet);
        ...
        likesRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.child(postKey).hasChild(myUid)) {
                    ...
                    holder.likeBtn.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_star_blue, 0, 0, 0);
                     ...
                     * Cambiar el icono izquierdo dibujable del botón
                     * cambia el texto del botón Me gusta de "Me gusta" a "Me gusta" */
                    holder.likeBtn.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_star_black, 0, 0, 0);
                    holder.likeBtn.setText(R.string.likebtn);
                }
            }
        ...
        picRef.delete()
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Query fquery = FirebaseDatabase.getInstance().getReference("Services").orderByChild("pId").equalTo(pId);
    ...
    class MyHolder extends RecyclerView.ViewHolder {
        ...
        TextView uNameTv, pTimeTv, pTitleTv, pLocationTv, pScheduleTv, pLikesTv, pCommentsTv;
        ImageButton moreBtn;
        ...
        public MyHolder(@NonNull View itemView) {
            ...
            pScheduleTv = itemView.findViewById(R.id.pScheduleTv);
